...
Verify Successful Login to OrangeHRM
    ...
    Wait Until Element Is Visible  id:txtUsername  timeout=15
    Input Text  id:txtUsername  Admin
    Input Password  id:txtPassword  admin123
    Click Element  id:btnLogin
    Element Should Be Visible  id:welcome  timeout=15
    Close Browser
...
Verify Successful Login to the-internet.herokuapp
    ...
    Element Should Be Visible  css:[href="/logout"]  timeout=15
    Close Browser
